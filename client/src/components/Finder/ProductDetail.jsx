...
const ProductDetail = memo(function ProductDetail({ product, onBack }) {
    ...
    return (
        ...
        >
            ...
            {/* Layout Vertical: Imagem Grande no topo */}
            <div className="detail-media-vertical">
            ...
            {/* Informação do Produto Abaixo da Imagem */}
            <motion.div
                className="detail-info-vertical"
            ...
            >
                ...
                {/* Características em Grelha Limpa */}
